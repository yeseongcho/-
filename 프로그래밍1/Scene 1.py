...
class Scene1 :
    ...
    def get_anim_data(self) :
        return self.man, self.bed.blanket, self.bed.beds, self.window1, self.table.table, self.table.table_leg1, self.table.table_leg2, self.table.table_leg3, self.table.table_leg4, self.sun.suns, self.door.doors, self.door.doors_sign, self.door.doors_hand, self.watch.watchs

# 여기서 마지막에 다 불러와 없애보자!
class Animation :
    def __init__(self, scene1) :
        man, blanket, bed, window, table, table_leg1, table_leg2, table_leg3, table_leg4, sun, door, door_sign, door_hand, watch = scene1.get_anim_data()
        self.mans = man
        self.blankets = blanket
        self.beds = bed
        self.tables = table
        self.tables_leg1 = table_leg1
        self.tables_leg2 = table_leg2
        self.tables_leg3 = table_leg3
        self.tables_leg4 = table_leg4
        self.suns = sun
        self.doors = door
    ...
    def move_man(self) :
        ...
        time.sleep(0.006)
        canvas.remove(self.tables)
        time.sleep(0.006)
        canvas.remove(self.tables_leg1)
        time.sleep(0.006)   
        canvas.remove(self.tables_leg2)
        time.sleep(0.006)
        canvas.remove(self.tables_leg3)
        time.sleep(0.006)
        canvas.remove(self.tables_leg4)
        time.sleep(0.006)
        ...
        time.sleep(0.006)
        canvas.remove(self.windows.windows1)
        time.sleep(0.006)
        canvas.remove(self.watchs)
        time.sleep(0.006)
        canvas.remove(text)
...
class Table :
    def __init__(self) :
        self.table = Polygon(Point(550, 150), Point(450, 250), Point(650, 250), Point(750, 150))
        self.table.setFillColor("brown")
        self.table.setBorderColor("black")
        self.table_leg1 = Rectangle(20, 150, Point(560, 225))
        self.table_leg2 = Rectangle(20, 150, Point(465, 320))
        self.table_leg3 = Rectangle(20, 150, Point(640, 325))
        self.table_leg4 = Rectangle(20, 150, Point(735, 225))
        self.table_leg1.setFillColor("brown")
        self.table_leg2.setFillColor("brown")
        self.table_leg3.setFillColor("brown")
        self.table_leg4.setFillColor("brown")
        self.table_leg1.setBorderColor("black")
        self.table_leg2.setBorderColor("black")
        self.table_leg3.setBorderColor("black")
        self.table_leg4.setBorderColor("black")
        self.table.setDepth(60)
        self.table_leg1.setDepth(70)
        self.table_leg2.setDepth(70)
        self.table_leg3.setDepth(70)
        self.table_leg4.setDepth(70)
        
        canvas.add(self.table)
        
        canvas.add(self.table_leg1)
        
        canvas.add(self.table_leg2)
        
        canvas.add(self.table_leg3)
        
        canvas.add(self.table_leg4)

class Watch :
    def __init__(self) :
        self.watchs = Rectangle(100, 50, Point(600, 200))
        self.watchs.setFillColor("white")
        self.watchs.setBorderColor("black")
        #self.watchs.setDepth(20)
        time.sleep(0.05)
        canvas.add(self.watchs)
...
class Window1 :
    def __init__(self) :
        self.windows1 = Rectangle(200, 170, Point(200, 200))
        self.windows1.setDepth(40)
        self.windows1.setFillColor("light blue")
        canvas.add(self.windows1)

class Sun :
    def __init__(self) :
        self.suns = Circle()
        self.suns.setRadius(25)
        self.suns.setDepth(30)
        self.suns.setFillColor("red")
        self.suns.setBorderColor("orange")
        self.suns.moveTo(160, 160)
...
class Man3 :
    def __init__(self) :
        ...
        self.mouse3 = Circle(21, Point(0, -250))
        self.mouse3.setFillColor("black")
        self.mouse3.setDepth(10)
        self.guy.add(self.mouse3)
